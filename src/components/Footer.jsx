  ...
  return (
    <div className='rounded-div mt-8 pt-8 text-primary'>
        <div className='grid md:grid-cols-2'>
            <div className='flex justify-evenly w-full md:m-w-[300px] uppercase'>
                <div>
            ...
            <div className='text-right'>
                <div className='w-full flex justify-end'>
                    <div className='w-full md:w-[300px] py-4 relative'>
                        ...
                        <p className='text-center md:text-right'>Sign up for crypto information</p>
                        <div className='py-4'>
                            <form>
                                <input className='bg-primary border border-input p-2 mr-2 w-full shadow-xl rounded=2xl md:w-auto' type="email" placeholder='Enter Email' />
